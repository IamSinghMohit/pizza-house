...
export const UpdateproductIcon = () => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const CandyIcon = ({ width, height }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={`${width || 24}`}
        height={`${height || 24}`}
...
export const ChangeIcon = ({ width, height }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={`${width || 24}`}
        height={`${height || 24}`}
...
export const MenuCloseIcon = ({ width, height }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={`${width || 24}`}
        height={`${height || 24}`}
